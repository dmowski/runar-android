...
class DescriptionDialog(description: String,header: String,fontSize: Float) : View.OnClickListener {
    ...
    fun showDialog(activity : FragmentActivity){
        ...
        val header = dialog.findViewById<FrameLayout>(com.test.runar.R.id.description_header_frame).getChildAt(0) as TextView
        ...
        dialog.findViewById<FrameLayout>(com.test.runar.R.id.description_button_frame).setOnClickListener(this)
